...
import { arabCountries } from "@/constants/MenuLinks/PhoneCodes";
...
const CustomPhoneInput: React.FC<CustomPhoneInputProps> = ({
  ...
  const getBorderStyling = () => {
    ...
    return "border-[1px] border-gray-600 ";
  };
        ...
        >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className={cn(
                  "flex h-11 items-center rounded-none border-r-2 border-gray-300 dark:border-gray-700 !px-2",
          ...
          <div className="relative flex-1">
            <Input
              ...
              className={cn(
                "h-11 border-0 rounded-none bg-transparent text-sm",
